<template>
  <div class="tables-edit-outer">
    ...
    <div v-else class="tables-editting-con">
      <Input :value="value" @input="handleInput" style="width: 50%" class="tables-edit-input"/>
      <Button @click="saveEdit" style="padding: 6px 2px;" type="text"><Icon type="md-checkmark"></Icon></Button>
