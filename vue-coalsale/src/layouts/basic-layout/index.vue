<template>
    <Layout class="i-layout" style="height: 100%;">
        ...
        <Layout class="i-layout-inside" :class="insideClasses" style="height: 100%;">
            ...
            <Content class="i-layout-content" :class="contentClasses">
                ...
                <div class="i-layout-content-main" style="height: 100%;">
...
<script>
    ...
    import iHeaderSwitchPost from './header-switchPost';
    ...
    export default {
        name: 'BasicLayout',
        components: { iMenuHead, iMenuSide, iCopyright, iHeaderLogo, iHeaderCollapse, iHeaderReload, iHeaderBreadcrumb, iHeaderSearch, iHeaderSwitchPost, iHeaderUser, iHeaderI18n, iHeaderLog, iHeaderFullscreen, iHeaderSetting, iHeaderNotice, iTabs },
        data () {
            return {
                showDrawer: false,
                ticking: false,
