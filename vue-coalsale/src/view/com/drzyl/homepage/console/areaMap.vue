<template>
  <Row :gutter="24">
      <Col :xl="24" :lg="24" :md="24" :sm="24" :xs="24" style="padding: 0">
          <Card :bordered="true">
            <!-- <div class="echarts"> -->
              <div :style="{height:'600px',width:'100%'}" ref="areaMap" class="centerItem"></div>
            <!-- </div> -->
          </Card>
      </Col>
  </Row>
...
export default {
  ...
  methods: {
    initChinaMap () {
      let mapBoxEchart = echarts.init(this.$refs.areaMap);
