export default class DictValueQuery {
  constructor () {
    this.toolExists = null // 解决多对多关系预留字段之存在
    this.toolNotExists = null // 解决多对多关系预留字段之不存在
    this.dictValueId = null // 数据字典值编号
    this.code = null // 代码
    this.displayName = null // 显示名称
    ...
    this.dictValueIdAndin = null // 数据字典值编号Andin查询
    this.codeAndeq = null // 代码Andeq查询
    this.dictIdAndeq = null // 数据字典编号Andeq查询
    this.codeAndKeyLike = null // 代码AndKeyLike查询
    this.displayNameOrKeyLike = null // 显示名称OrKeyLike查询
    this.descriptionOrKeyLike = null // 描述OrKeyLike查询
    this.dictIdOrKeyLike = null // 数据字典编号OrKeyLike查询
