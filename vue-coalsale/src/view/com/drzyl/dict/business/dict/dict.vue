          ...
          <Row type="flex" justify="center">
            ...
            <Col :xs="24" :sm="20" :md="18" :lg="14">
              <FormItem label="说明：" prop="notes">
                <Input v-model="dict.notes" type="textarea" :rows="15" placeholder="输入说明"></Input>
              </FormItem>
            </Col>
            <Col :xs="24" :sm="20" :md="18" :lg="14">
    ...
    <Drawer width="45" v-model="dictDetailDrawerShow" :closable="false">
      <Card>
        ...
        <Row>
          ...
          <Col :xs="24" :sm="24" :md="24" :lg="24">
            <!-- <p>说明：{{ dict.notes }}</p> -->
            <p>说明：（<span style="color: #ed4014">编辑无效</span>）</p>
            <Input class="pro-margin-top-8" v-model="dict.notes" type="textarea" :rows="20" />
            <Divider dashed />
          </Col>
          <Col :xs="24" :sm="24" :md="24" :lg="24">
