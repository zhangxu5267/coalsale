  ...
  <div>
    <Card>
      ...
      <Poptip class="pro-margin-top-12 pro-float-right" placement="left-start" width="173">
        ...
        <div slot="content">
          <CheckboxGroup class="pro-margin-top-12" v-model="loginLogColumnsChecked" @on-change="changeLoginLogColumns">
            <Row type="flex" justify="center">
              ...
              <Col span="24">
                <Checkbox class="pro-margin-left-2" label="loginTimes">登录时间</Checkbox>
              </Col>
            </Row>
          </CheckboxGroup>
          <Divider />
          <Button class="pro-margin-left-2 pro-margin-bottom-12" @click="cleanLoginLogColumns()">清空</Button>
          <Button class="pro-margin-left-8 pro-margin-bottom-12" @click="resetLoginLogColumns()">重置</Button>
        </div>
      </Poptip>
...
import LoginLog from '@/view/com/drzyl/sign/loginLog/LoginLog'
import LoginLogQuery from '@/view/com/drzyl/sign/loginLog/LoginLogQuery'
...
export default {
  data () {
    return {
      loginLogColumns: [
        ...
        { title: '登录时间', key: 'loginTimes', minWidth: 200, sortable: true }
      ],
      ...
      loginLogColumnsNexus: {
        logId: { type: 'selection', width: 55, align: 'center', fixed: 'left' },
        ...
        loginTimes: { title: '登录时间', key: 'loginTimes', minWidth: 200, sortable: true }
      },
      loginLogSet: [],
      loginLogCount: 0,
      loginLogRows: 10,
  ...
  methods: {
    ...
    changeLoginLogColumns () {
      this.loginLogColumns = []
      this.loginLogColumnsChecked.forEach(col => this.loginLogColumns.push(this.loginLogColumnsNexus[col]))
    },
    cleanLoginLogColumns () {
      this.loginLogColumnsChecked = [
        'logId'
      ]
      this.loginLogColumns = []
      this.loginLogColumnsChecked.forEach(col => this.loginLogColumns.push(this.loginLogColumnsNexus[col]))
    },
    resetLoginLogColumns () {
      this.loginLogColumnsChecked = [
        'logId',
        'loginKey',
        'accountId',
