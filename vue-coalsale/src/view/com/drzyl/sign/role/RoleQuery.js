export default class RoleQuery {
  constructor () {
    ...
    this.roleIdAndin = null // 角色编号Andin查询
    this.roleNameAndeq = null // 角色名称Andeq查询
    this.roleNameAndKeyLike = null // 角色名称AndKeyLike查询
    this.roleTypeOrKeyLike = null // 角色类型OrKeyLike查询
    this.accessListOrKeyLike = null // 权限列表OrKeyLike查询
