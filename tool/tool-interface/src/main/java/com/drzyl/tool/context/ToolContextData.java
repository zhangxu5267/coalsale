...
public final class ToolContextData {
  ...
  private static final ThreadLocal<OrgInfo> orgInfoThreadLocal = new ThreadLocal<>();
  ...
  public static final OrgInfo getOrgInfo() {
    return (OrgInfo) orgInfoThreadLocal.get();
  }

  public static final void setOrgInfo(OrgInfo orgInfo) {
    orgInfoThreadLocal.set(orgInfo);
  }

  public static final void removeOrgInfo() {
    orgInfoThreadLocal.remove();
  }
