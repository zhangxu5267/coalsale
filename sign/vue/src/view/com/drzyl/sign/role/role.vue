            ...
            <div slot="content">
              <Form class="pro-margin-top-10" ref="roleQueryForm" :model="roleQuery" :label-width="120">
                <Row>
                  ...
                  <Col span="8">
                    <FormItem label="权限列表：" prop="accessList">
                      <Input v-model="roleQuery.accessList" placeholder="输入权限列表"></Input>
                    </FormItem>
                  </Col>
                  <Col span="8">
        ...
        <div slot="content">
          <CheckboxGroup class="pro-margin-top-12" v-model="roleColumnsChecked" @on-change="changeRoleColumns">
            <Row type="flex" justify="center">
              ...
              <Col span="24">
                <Checkbox class="pro-margin-left-2" label="accessList">权限列表</Checkbox>
              </Col>
              <Col span="24">
      ...
      <Card>
        ...
        <Form class="pro-margin-top-20" ref="roleForm" :model="role" :rules="roleFormValidate" :label-width="120">
          <Row type="flex" justify="center">
            ...
            <Col :xs="24" :sm="20" :md="18" :lg="14">
              <FormItem label="权限列表：" prop="accessList">
                <Input v-model="role.accessList" placeholder="输入权限列表"></Input>
              </FormItem>
            </Col>
            <Col :xs="24" :sm="20" :md="18" :lg="14">
              <FormItem label="排序权重：" prop="weightOrder">
            ...
            <Col :xs="24" :sm="20" :md="18" :lg="14">
              <FormItem label="版本号：" prop="versions">
                <InputNumber v-model="role.versions"></InputNumber>
              </FormItem>
            </Col>
            <Col :xs="24" :sm="20" :md="18" :lg="14">
              <FormItem label="创建人账号：" prop="createId">
                <Input v-model="role.createId" placeholder="输入创建人账号"></Input>
              </FormItem>
            </Col>
            <Col :xs="24" :sm="20" :md="18" :lg="14">
              <FormItem label="创建人名称：" prop="createName">
                <Input v-model="role.createName" placeholder="输入创建人名称"></Input>
              </FormItem>
            </Col>
            <Col :xs="24" :sm="20" :md="18" :lg="14">
              <FormItem label="创建时间：" prop="createTimes">
                <InputNumber v-model="role.createTimes"></InputNumber>
              </FormItem>
            </Col>
            <Col :xs="24" :sm="20" :md="18" :lg="14">
              <FormItem label="修改人账号：" prop="modifyId">
                <Input v-model="role.modifyId" placeholder="输入修改人账号"></Input>
              </FormItem>
            </Col>
            <Col :xs="24" :sm="20" :md="18" :lg="14">
              <FormItem label="修改人名称：" prop="modifyName">
                <Input v-model="role.modifyName" placeholder="输入修改人名称"></Input>
              </FormItem>
            </Col>
            <Col :xs="24" :sm="20" :md="18" :lg="14">
              <FormItem label="修改时间：" prop="modifyTimes">
                <InputNumber v-model="role.modifyTimes"></InputNumber>
              </FormItem>
            </Col>
            <Col :xs="24" :sm="20" :md="18" :lg="14">
              <FormItem>
  ...
  data () {
    return {
      roleColumns: [
        ...
        { title: '权限列表', key: 'accessList', minWidth: 200, sortable: true },
      ...
      roleColumnsNexus: {
        ...
        accessList: { title: '权限列表', key: 'accessList', minWidth: 200, sortable: true },
  ...
  methods: {
    ...
    keySearchRole (keyLikeValue) {
      if (keyLikeValue !== '') {
        ...
        roleQueryKeySearch.accessListOrKeyLike = '%' + keyLikeValue + '%'
        roleQueryKeySearch.createIdOrKeyLike = '%' + keyLikeValue + '%'
        roleQueryKeySearch.createNameOrKeyLike = '%' + keyLikeValue + '%'
        roleQueryKeySearch.modifyIdOrKeyLike = '%' + keyLikeValue + '%'
        roleQueryKeySearch.modifyNameOrKeyLike = '%' + keyLikeValue + '%'
