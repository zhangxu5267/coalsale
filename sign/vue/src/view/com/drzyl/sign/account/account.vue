      ...
      <Card>
        ...
        <Form class="pro-margin-top-20" ref="accountForm" :model="account" :rules="accountFormValidate" :label-width="120">
          <Row type="flex" justify="center">
            ...
            <Col :xs="24" :sm="20" :md="18" :lg="14">
              <FormItem label="创建人账号：" prop="createId">
                <Input v-model="account.createId" placeholder="输入创建人账号"></Input>
              </FormItem>
            </Col>
            <Col :xs="24" :sm="20" :md="18" :lg="14">
              <FormItem label="创建人名称：" prop="createName">
                <Input v-model="account.createName" placeholder="输入创建人名称"></Input>
              </FormItem>
            </Col>
            <Col :xs="24" :sm="20" :md="18" :lg="14">
              <FormItem label="创建时间：" prop="createTimes">
                <InputNumber v-model="account.createTimes"></InputNumber>
              </FormItem>
            </Col>
            <Col :xs="24" :sm="20" :md="18" :lg="14">
              <FormItem label="修改人账号：" prop="modifyId">
                <Input v-model="account.modifyId" placeholder="输入修改人账号"></Input>
              </FormItem>
            </Col>
            <Col :xs="24" :sm="20" :md="18" :lg="14">
              <FormItem label="修改人名称：" prop="modifyName">
                <Input v-model="account.modifyName" placeholder="输入修改人名称"></Input>
              </FormItem>
            </Col>
            <Col :xs="24" :sm="20" :md="18" :lg="14">
              <FormItem label="修改时间：" prop="modifyTimes">
                <InputNumber v-model="account.modifyTimes"></InputNumber>
              </FormItem>
            </Col>
            <Col :xs="24" :sm="20" :md="18" :lg="14">
              <FormItem>
  ...
  data () {
    return {
      accountColumns: [
        ...
        { title: '关联类型', key: 'nexusType', minWidth: 200, sortable: true },
        { title: '对象编号', key: 'nexusObjectId', minWidth: 200, sortable: true },
  ...
  methods: {
    ...
    keySearchAccount (keyLikeValue) {
      if (keyLikeValue !== '') {
        ...
        accountQueryKeySearch.createIdOrKeyLike = '%' + keyLikeValue + '%'
        accountQueryKeySearch.createNameOrKeyLike = '%' + keyLikeValue + '%'
        accountQueryKeySearch.modifyIdOrKeyLike = '%' + keyLikeValue + '%'
        accountQueryKeySearch.modifyNameOrKeyLike = '%' + keyLikeValue + '%'
