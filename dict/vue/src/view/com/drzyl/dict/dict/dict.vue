  ...
  <div>
    <Card>
      ...
      <Poptip class="pro-margin-top-12 pro-float-right" placement="left-start" width="173">
        ...
        <div slot="content">
          <CheckboxGroup class="pro-margin-top-12" v-model="dictColumnsChecked" @on-change="changeDictColumns">
            <Row type="flex" justify="center">
              <Col span="24">
                <Checkbox class="pro-margin-left-2" label="dictKey">数据字典标识</Checkbox>
              </Col>
              <Col span="24">
                <Checkbox class="pro-margin-left-2" label="dictName">数据字典名称</Checkbox>
              </Col>
              <Col span="24">
                <Checkbox class="pro-margin-left-2" label="notes">说明</Checkbox>
              </Col>
              <Col span="24">
          ...
          <Divider />
          <Button class="pro-margin-left-2 pro-margin-bottom-12" @click="cleanDictColumns()">清空</Button>
          <Button class="pro-margin-left-8 pro-margin-bottom-12" @click="resetDictColumns()">重置</Button>
        </div>
      </Poptip>
...
import Dict from '@/view/com/drzyl/dict/dict/Dict'
...
export default {
  data () {
    return {
      dictColumns: [
        ...
        { title: '数据字典标识', key: 'dictKey', minWidth: 200, sortable: true },
        { title: '数据字典名称', key: 'dictName', minWidth: 200, sortable: true },
        { title: '说明', key: 'notes', minWidth: 200, sortable: true },
      ...
      dictColumnsNexus: {
        dictId: { type: 'selection', width: 50, align: 'center', fixed: 'left' },
        dictKey: { title: '数据字典标识', key: 'dictKey', minWidth: 200, sortable: true },
        dictName: { title: '数据字典名称', key: 'dictName', minWidth: 200, sortable: true },
        notes: { title: '说明', key: 'notes', minWidth: 200, sortable: true },
  ...
  methods: {
    ...
    changeDictColumns () {
      this.dictColumns = []
      this.dictColumnsChecked.forEach(col => this.dictColumns.push(this.dictColumnsNexus[col]))
    },
    cleanDictColumns () {
      this.dictColumnsChecked = [
        'dictId'
      ]
      this.dictColumns = []
      this.dictColumnsChecked.forEach(col => this.dictColumns.push(this.dictColumnsNexus[col]))
