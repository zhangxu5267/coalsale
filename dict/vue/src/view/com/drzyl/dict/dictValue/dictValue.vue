  ...
  <div>
    <Card>
      ...
      <Poptip class="pro-margin-top-12 pro-float-right" placement="left-start" width="173">
        ...
        <div slot="content">
          <CheckboxGroup class="pro-margin-top-12" v-model="dictValueColumnsChecked" @on-change="changeDictValueColumns">
            <Row type="flex" justify="center">
              <Col span="24">
                <Checkbox class="pro-margin-left-2" label="code">代码</Checkbox>
              </Col>
              <Col span="24">
                <Checkbox class="pro-margin-left-2" label="displayName">显示名称</Checkbox>
              </Col>
              <Col span="24">
              ...
              <Col span="24">
                <Checkbox class="pro-margin-left-2" label="dictId">数据字典编号</Checkbox>
              </Col>
              <Col span="24">
          ...
          <Divider />
          <Button class="pro-margin-left-2 pro-margin-bottom-12" @click="cleanDictValueColumns()">清空</Button>
          <Button class="pro-margin-left-8 pro-margin-bottom-12" @click="resetDictValueColumns()">重置</Button>
        </div>
      </Poptip>
...
import DictValue from '@/view/com/drzyl/dict/dictValue/DictValue'
import DictValueQuery from '@/view/com/drzyl/dict/dictValue/DictValueQuery'
...
export default {
  data () {
    return {
      dictValueColumns: [
        ...
        { title: '代码', key: 'code', minWidth: 200, sortable: true },
        { title: '显示名称', key: 'displayName', minWidth: 200, sortable: true },
        { title: '排序权重', key: 'weightOrder', minWidth: 200, sortable: true },
        { title: '描述', key: 'description', minWidth: 200, sortable: true },
        { title: '数据字典编号', key: 'dictId', minWidth: 200, sortable: true },
      ...
      dictValueColumnsNexus: {
        dictValueId: { type: 'selection', width: 50, align: 'center', fixed: 'left' },
        code: { title: '代码', key: 'code', minWidth: 200, sortable: true },
        displayName: { title: '显示名称', key: 'displayName', minWidth: 200, sortable: true },
        ...
        dictId: { title: '数据字典编号', key: 'dictId', minWidth: 200, sortable: true },
  ...
  methods: {
    ...
    changeDictValueColumns () {
      this.dictValueColumns = []
      this.dictValueColumnsChecked.forEach(col => this.dictValueColumns.push(this.dictValueColumnsNexus[col]))
    },
    cleanDictValueColumns () {
      this.dictValueColumnsChecked = [
        'dictValueId'
      ]
      this.dictValueColumns = []
      this.dictValueColumnsChecked.forEach(col => this.dictValueColumns.push(this.dictValueColumnsNexus[col]))
    },
    resetDictValueColumns () {
      this.dictValueColumnsChecked = [
        'dictValueId',
        'code',
        'displayName',
